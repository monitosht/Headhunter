...
namespace ProceduralLevelGenerator.Unity.Examples.EnterTheGungeon.Scripts
{
    public class GungeonRoomManager : MonoBehaviour
    {
        ...
        /// public float minEnemies = 1, maxEnemies = 4;
        ...
        private void Update()
        {
            ...
            if(EnemiesSpawned == true)
            {
                if(timer <= 0)
                {
                    ...
                    {
                        StartCoroutine(WaitBeforeOpeningDoors(1));
                        timer = 1f;
                    }
                }
                else
            ...
            if (spawnedEnemies.Length == 0 && roomStarted == true)
            {
                roomStarted = false;
                StartCoroutine(WaitBeforeOpeningDoors(1));
            }
        ...
        private void SpawnEnemies()
        {
            ...
            var totalEnemiesCount = GungeonGameManager.Instance.Random.Next(1, 4);
