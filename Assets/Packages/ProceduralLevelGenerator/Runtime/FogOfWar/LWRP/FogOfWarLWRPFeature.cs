...
namespace Edgar.Unity
{
    ...
    /// </summary>
    public class FogOfWarLWRPFeature : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        ...
        internal class BlitPass : UnityEngine.Rendering.Universal.ScriptableRenderPass
        {
            ...
            UnityEngine.Rendering.Universal.RenderTargetHandle m_DestinationTexture;
            string m_ProfilerTag;

            public BlitPass(UnityEngine.Rendering.Universal.RenderPassEvent renderPassEvent, BlitSettings settings, string tag)
            {
        ...
        internal class BlitSettings
        {
            ...
            public UnityEngine.Rendering.Universal.RenderPassEvent Event = UnityEngine.Rendering.Universal.RenderPassEvent.BeforeRenderingPostProcessing;
        ...
        public override void Create()
        {
            ...
            if (settings.Event == UnityEngine.Rendering.Universal.RenderPassEvent.AfterRenderingPostProcessing)
            {
        ...
        public override void AddRenderPasses(UnityEngine.Rendering.Universal.ScriptableRenderer renderer, ref UnityEngine.Rendering.Universal.RenderingData renderingData)
        {
            ...
            if (renderingData.cameraData.camera.GetComponent<FogOfWar>() == null)
            {
                return;
            }

            var material = FogOfWar.Instance.GetMaterial();
